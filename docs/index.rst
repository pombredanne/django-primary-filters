.. django-primary-filters documentation master file, created by
   sphinx-quickstart on Sun Nov 14 09:50:21 2010.
   You can adapt this file completely to your liking, but it should at least
   contain the root `toctree` directive.

=========================
django-primary-filters's documentation
=========================
...
Welcome to the *django-primary-filters*'s documentation!
...
| **Source Code Repository**: `django-primary-filters source code <https://source.codetrax.org/hgroot/django-primary-filters>`_
| **Documentation**: `django-primary-filters documentation <http://packages.python.org/django-primary-filters>`_
| **Downloads**: `django-primary-filters releases <http://pypi.python.org/pypi/django-primary-filters>`_


About this guide
================

This guide provides an introduction to the *django-primary-filters* |version| release,
